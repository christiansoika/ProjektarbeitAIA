...
\end{equation}
\begin{equation}
\vec{a}_{n+1} = \frac{\vec{v}_n + \frac{1}{2} \delta t \left(\vec{u}_{n+1}^\mathrm{(p)} - \vec{v}_n - \frac{1}{2} \delta t \vec{a}_n \right) + \vec{g}}{1 + \frac{1}{2} \frac{f_\mathrm{D}}{\tau_\mathrm{p}} \delta t}
\end{equation}
